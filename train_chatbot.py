...
#layers import Dense, Activation, Dropout
...
#sgd = keras.optimizers.SGD(lr=0.0099, decay=1e-10, momentum=0.9, nesterov=True)
#model.compile(loss='categorical_crossentropy', optimizer=sgd, metrics=['accuracy'])

#ADAM optimizer
opt = keras.optimizers.Adam(learning_rate=0.0099)
